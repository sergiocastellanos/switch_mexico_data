...
class PySSC:
	...
	def __init__(self):
		...
		if sys.platform == 'win32' or sys.platform == 'cygwin':
		    ...
		    self.pdll = CDLL(os.path.abspath("/home/matr/BECI/SWITCH-LATAM/Python/SAM/sam-sdk-2016-3-14-r3/linux64/ssc.so"))   # instead of relative path, require user to have on LD_LIBRARY_PATH
		else:
