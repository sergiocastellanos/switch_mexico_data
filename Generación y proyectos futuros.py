...
df= pd.read_csv("C:/Users/Aldo/Documents/Facultad/Internship Berkeley/Datos SWITCH/sener/proyectos futuros inversion.csv",index_col=range(2),header=0)
...
dft=pd.read_csv('C:/Users/Aldo/Documents/Facultad/Internship Berkeley/Datos SWITCH/Costo transmision proyectos.csv',header=0)
plt.figure(1,figsize=(10,7),dpi = 200)
...
comb=pd.read_csv('C:/Users/Aldo/Documents/Facultad/Internship Berkeley/Datos SWITCH/combustibles.csv',header=0)
...
cost_sen=pd.read_csv('C:/Users/Aldo/Documents/Facultad/Internship Berkeley/Datos SWITCH/costo SEN.csv',header=0,index_col=0)
...
ev_cap=pd.read_csv('C:/Users/Aldo/Documents/Facultad/Internship Berkeley/Datos SWITCH/evolucion capacidad por tecnologia.csv',index_col=0,header=0)
ev_gen=pd.read_csv('C:/Users/Aldo/Documents/Facultad/Internship Berkeley/Datos SWITCH/evolucion generacion por tecnologia2.csv',index_col=0,header=0)
ev_cap=ev_cap.T
ev_gen=ev_gen.T
